...
type TPersonWithCPRNumber = Pick<typeof Person.prototype, "name" | "surname" | "gender" | "birthdate">
...
describe("Negative", () => {
	...
	it("Should fail to validate CPR if gender does not match", () => {
		...
		const isValid = validateCprForPerson(person.birthdate, person.gender, maleCprResult.data);
